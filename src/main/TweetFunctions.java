...
public class TweetFunctions {
	...
	public static void setupTweets() {
		ConfigurationBuilder cb = new ConfigurationBuilder();
		cb.setDebugEnabled(true).setOAuthConsumerKey("R0rX5c2rsDHA6BMK0b7CAegGR")
				.setOAuthConsumerSecret("mrFMBzujuBBro9ArebUPnIu523t4yMUSc3j4AET5Eqm73b2KYb")
				.setOAuthAccessToken("3189101448-XrTbHc6clsq2OoTJYnB6x47r1TJ1t7IOnV4R6h1")
				.setOAuthAccessTokenSecret("5mvjOPMxjKx4OsC4xdPyuz1Q6mqGAmnwSLL2xGbTYL9iI").setJSONStoreEnabled(true);
	...
	public static void tweet(String toTweet) throws TwitterException {
